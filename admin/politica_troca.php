...
if($_POST['cmd'] == "add")
{
	$str = "INSERT INTO politica_troca (texto) VALUES ('$texto')";
	$rs  = mysql_query($str) or die(mysql_error());
			
	redireciona("politica_troca.php?ind_msg=1");
}

if($_POST['cmd'] == "edit")
{
	$str = "UPDATE politica_troca SET texto = '$texto' WHERE codigo = '$codigo'";
	$rs  = mysql_query($str) or die(mysql_error());
	
	redireciona("politica_troca.php?ind_msg=2");
}
...
$str = "SELECT * FROM politica_troca ";
$rs  = mysql_query($str) or die(mysql_error());
