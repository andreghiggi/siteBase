...
if($_POST['cmd'] == "add")
{
	$str = "INSERT INTO como_comprar (texto) VALUES ('$texto')";
	$rs  = mysql_query($str) or die(mysql_error());
			
	redireciona("como_comprar.php?ind_msg=1");
}

if($_POST['cmd'] == "edit")
{
	$str = "UPDATE como_comprar SET texto = '$texto' WHERE codigo = '$codigo'";
	$rs  = mysql_query($str) or die(mysql_error());
	
	redireciona("como_comprar.php?ind_msg=2");
}
