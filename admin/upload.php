...
class UploadHandler
{
	...
	{        
		...
		$dir_self = substr($_SERVER['PHP_SELF'], 0, -6);
                
        $this->options = array(
            'script_url' => $_SERVER['PHP_SELF'],
            'upload_dir' => $dir.'/upload/',
            'upload_url' => $dir_self.'/upload/',
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                'thumbnail' => array(
                    'upload_dir' => $dir.'/upload/thumbnails/',
                    'upload_url' => $dir_self.'/upload/thumbnails/',
                    'max_width' => 80,
                    'max_height' => 80
                )
            )
    ...
    private function handle_file_upload($uploaded_file, $name, $size, $type, $error) {
        ...
        $strpos = strpos($name, ".");
        $nome_imagem = substr($name, 0, $strpos);
        $ext = substr($name, $strpos);            
        $name = $nome_imagem."_".date(Ymd).$ext;
